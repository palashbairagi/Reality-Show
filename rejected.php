...
<body>
	...
	<div id="body">
		<div class="content">
	<h2>Rejected Contestants</h2>
			<ul>
			
<?php

$con=mysqli_connect("localhost","root","root","audition") or die("Connection Failed");
$rs = mysqli_query($con,"select * from contestant where status='rejected'");
    if (mysqli_num_rows($rs) > 0) {
        ...
        while ($row = mysqli_fetch_array($rs)) 
		{
			...
			<td width='100'><a href="deleteContestant.php?id=<?php echo $row['id']?>"><img src="images/x.png" alt="Delete" title="Delete"/></a>
			</tr>
			</table>
			</b>
			</li>
